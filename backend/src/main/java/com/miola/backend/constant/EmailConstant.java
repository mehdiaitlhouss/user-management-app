...
public class EmailConstant {
    ...
    public static final String USERNAME = "mehdi.aitlhouss@um5r.ac.ma";
    public static final String PASSWORD = "oQ$GgA8JYDEOxKQbzA6O";
    public static final String FROM_EMAIL = "admin@user.managment.app";
