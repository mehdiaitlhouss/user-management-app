...
public class ExceptionHandling implements ErrorController {
    ...
    public static final String METHODE_IS_NOT_ALLOWED = "This request methode is not allowed on this endpoint. Please send a '%s' request";
...
//    }
    ...
    public ResponseEntity<HttpResponse> methodeNotSupportedException(HttpRequestMethodNotSupportedException exception) {
        HttpMethod supportedMethod =
                Objects.requireNonNull(exception.getSupportedHttpMethods())
                        .iterator()
                        .next();
        return createHttpResponse(METHOD_NOT_ALLOWED, String.format(METHODE_IS_NOT_ALLOWED, supportedMethod));
    }
